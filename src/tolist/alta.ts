import { TareaTipo, TareaCtor } from "./contructora"; 
import promptSync from "prompt-sync";                  
const prompt = promptSync({ sigint: true });          
//alta
export function altaTarea():TareaTipo{
...
const tarea=new (TareaCtor as any)(  //le decimos trata a tarea contructor como vacio asi type no jode
  titulo,
    descripcion,
    estado,
    fechaCreacion,
    fechaEdicion,
    diaVencimiento+"/"+mesVencimiento,
    dificultad
);//esta instancia respeta la interfaz tarea tipo
