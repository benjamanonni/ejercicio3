...
exports.altaTarea = altaTarea;
const contructora_1 = require("./contructora");
...
function altaTarea() {
    ...
    //aca se ve el cambio,antes creabamos el objeto ahora lo hacemos con prototipo
    //new crea nueva instancia usando prototipo
    const tarea = new contructora_1.TareaCtor(//le decimos trata a tarea contructor como vacio asi type no jode
    titulo, descripcion, estado, fechaCreacion, fechaEdicion, diaVencimiento + "/" + mesVencimiento, dificultad); //esta instancia respeta la interfaz tarea tipo
